...
const nprimg =
  "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d7/National_Public_Radio_logo.svg/1200px-National_Public_Radio_logo.svg.png";
...
router.get("/scrape", function(req, res) {
  ...
  db.Article.deleteMany({}).then(() => {
    ...
    //     db.Article.find({})
    //       .then(dbArticle => {
    //         console.log("returned Articels: " + dbArticle);
